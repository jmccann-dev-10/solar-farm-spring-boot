...
class SolarPanelServiceTest {
    ...
    void shouldNotDeleteNonExistentSolarPanel() throws DataAccessException {
        SolarPanelResult result = service.deleteByKey(new SolarPanelKey("Section Two", 100, 100));
    ...
    void shouldDelete() throws DataAccessException {
        SolarPanelResult result = service.deleteByKey(new SolarPanelKey("Section One", 1, 1));
